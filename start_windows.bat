@echo off
title Village Market - Buyer and Farmer Server (Port 8000)
cd /d "%~dp0"
if not exist .env (
echo.
...
echo.
echo ========================================
echo Village Market Buyer/Farmer Server
echo URL: http://127.0.0.1:8000/
echo ========================================
echo.
start "Village Market Buyer/Farmer" cmd /c "timeout /t 2 /nobreak >nul && start http://127.0.0.1:8000/"
