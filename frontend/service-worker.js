const CACHE='village-market-v110-role-specific-nav';
const SHELL=['/','/static/style.css?v=110','/static/app.js?v=110','/static/offline.html','/static/icon-192.png','/static/icon-512.png','/static/apple-touch-icon.png','/static/favicon.png'];
