const CACHE='village-market-v111-full-row-role-nav';
const SHELL=['/','/static/style.css?v=111','/static/app.js?v=111','/static/offline.html','/static/icon-192.png','/static/icon-512.png','/static/apple-touch-icon.png','/static/favicon.png'];
